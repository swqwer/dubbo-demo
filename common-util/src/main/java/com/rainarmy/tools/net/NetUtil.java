package com.rainarmy.tools.net;

import com.rainarmy.tools.base.PlatForms;
import com.rainarmy.tools.base.SystemPropertiesUtil;
...
public class NetUtil {
    ...
    private static class LocalAddress {
        ...
        private static InetAddress findLocalAddressViaNetworkInterface() {
            ...
            Map<String, NetworkInterface> candidateInterfaces = new LinkedHashMap<>();
